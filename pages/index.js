...
export default function PaginaInicial() {
  // const username = 'eduardodiniz05';
  const [username, setUsername] = React.useState('eduardodiniz05');
        ...
        >
          ...
          <Box
            ...
            onSubmit = {function (infosDoEvento) {
              ...
              console.log('houve mudanças no formulario')
             
             //primeira forma de se fazer troca de pagina
